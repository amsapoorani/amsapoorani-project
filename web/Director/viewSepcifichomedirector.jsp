<%-- 
    Document   : viewSepcifichomedirector
    Created on : 29 Mar, 2022, 9:53:37 AM
    Author     : VINOTH
--%>
...
<html>
    ...
    <body style="background-color: black">
        <h1 style="color:lavender;font-family:cursive">View Specific Director Details</h1>
         <form action="viewspecificDirector.jsp">
        <div class="mb-3 mt-3" >
