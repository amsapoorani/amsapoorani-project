<%-- 
    Document   : DeletespecificMovie_casthome
    Created on : 29 Mar, 2022, 10:41:40 AM
    Author     : VINOTH
--%>
...
<html>
    <head>
        ...
        <title>delete specific movie_cast</title>
    </head>
    <body style="background-color: black">
        <h1 style="color:lavender;font-family:cursive">Delete Specific Movie_cast Details</h1>
         <form action="DeleteSpecificMovie_cast.jsp">
        <div class="mb-3 mt-3" >
