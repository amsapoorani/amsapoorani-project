<%-- 
    Document   : UpdateSpecificMovie_cast
    Created on : 29 Mar, 2022, 10:56:32 AM
    Author     : VINOTH
--%>
...
<html>
    ...
    <body style="background-color: black">
        <h1 style="color:lavender;font-family:cursive">update Movie_cast Record</h1>
       ...
       <%   Class.forName("com.mysql.jdbc.Driver");
           ...
           boolean flag=false;
            if(updata.equals("Role"))
            {
               String sqlselect = "update moviedatabase.movie_cast set ROLE='"+upfield+"'"
