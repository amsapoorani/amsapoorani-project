<%-- 
    Document   : DeletespecificMovies
    Created on : 29 Mar, 2022, 11:24:44 AM
    Author     : VINOTH
--%>
...
<html>
    ...
    <body style="background-color: black">
        <h1 style="color:lavender;font-family:cursive">Delete MOVIES Record</h1>
        <%
           ...
           String sql="delete from movies where MOV_ID='"+MOV_ID+"'";
