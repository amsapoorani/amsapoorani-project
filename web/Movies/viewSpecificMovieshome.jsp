<%-- 
    Document   : viewSpecificMovieshome
...
<html>
    <head>
        ...
        <title>View Specific Movies</title>
    </head>
    <body style="background-color: black">
        <h1 style="color:lavender;font-family:cursive">View Specific Movies Details</h1>
         <form action="viewspecificMovies.jsp">
        <div class="mb-3 mt-3" >
