<%-- 
    Document   : DeleteSpecificRatinghome
...
<html>
    <head>
        ...
        <title>Delete Specific Rating</title>
    </head>
    <body style="background-color: black">
        <h1 style="color:lavender;font-family:cursive">Delete Specific Rating Details</h1>
         <form action="DeleteSpecificRating.jsp">
        <div class="mb-3 mt-3" >
